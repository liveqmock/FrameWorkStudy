 ...
 */
@Controller
@RequestMapping(value = "/management/security/dataControl")
public class DataControlController {
    ...
    public String create(@Valid DataControl dataControl) {
        dataControlService.saveOrUpdate(dataControl);
        LogUtils.putArgs(LogMessageObject.newWrite().setObjects(new Object[]{dataControl.getId()}));
        return AjaxObject.newOk("数据权限添加成功！").toString();
    }

    @ModelAttribute(value = "preloadDataControl")
    ...
    public String update(@Valid @ModelAttribute("preloadDataControl") DataControl dataControl) {
        dataControlService.saveOrUpdate(dataControl);
        LogUtils.putArgs(LogMessageObject.newWrite().setObjects(new Object[]{dataControl.getId()}));
    ...
    public String delete(@PathVariable Long id) {
        ...
        LogUtils.putArgs(LogMessageObject.newWrite().setObjects(new Object[]{id}));
        return AjaxObject.newOk("删除数据权限成功").toString();
    }
