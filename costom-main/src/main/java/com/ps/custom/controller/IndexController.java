...
public class IndexController {
    ...
    public String updatePassword(ServletRequest request, String plainPassword, String newPassword, String rPassword) {
        ...
        if (newPassword != null && newPassword.equals(rPassword)) {
            ...
            try {
                ...
                LogUtils.putArgs(LogMessageObject.newIgnore());
    ...
    @ResponseBody
    public String updatebase(User user, ServletRequest request) {
